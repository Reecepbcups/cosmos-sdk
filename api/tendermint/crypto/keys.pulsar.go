...
var (
	...
	fd_PublicKey_ethsecp256k1 protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_PublicKey_ethsecp256k1 = md_PublicKey.Fields().ByName("ethsecp256k1")
}
...
func (x *fastReflection_PublicKey) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Sum != nil {
		...
		case *PublicKey_Ethsecp256K1:
			v := o.Ethsecp256K1
			value := protoreflect.ValueOfBytes(v)
			if !f(fd_PublicKey_ethsecp256k1, value) {
				return
			}
		}
	}
...
func (x *fastReflection_PublicKey) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "tendermint.crypto.PublicKey.ethsecp256k1":
		if x.Sum == nil {
			return false
		} else if _, ok := x.Sum.(*PublicKey_Ethsecp256K1); ok {
			return true
		} else {
			return false
		}
...
func (x *fastReflection_PublicKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "tendermint.crypto.PublicKey.ethsecp256k1":
		if x.Sum == nil {
			return protoreflect.ValueOfBytes(nil)
		} else if v, ok := x.Sum.(*PublicKey_Ethsecp256K1); ok {
			return protoreflect.ValueOfBytes(v.Ethsecp256K1)
		} else {
			return protoreflect.ValueOfBytes(nil)
		}
	default:
...
func (x *fastReflection_PublicKey) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "tendermint.crypto.PublicKey.ethsecp256k1":
		cv := value.Bytes()
		x.Sum = &PublicKey_Ethsecp256K1{Ethsecp256K1: cv}
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.crypto.PublicKey"))
		}
...
func (x *fastReflection_PublicKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "tendermint.crypto.PublicKey.ethsecp256k1":
		panic(fmt.Errorf("field ethsecp256k1 of message tendermint.crypto.PublicKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.crypto.PublicKey"))
		}
...
func (x *fastReflection_PublicKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	...
	case "tendermint.crypto.PublicKey.sum":
		...
		case *PublicKey_Ethsecp256K1:
			return x.Descriptor().Fields().ByName("ethsecp256k1")
		}
	default:
...
func (x *fastReflection_PublicKey) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		case *PublicKey_Secp256K1:
			...
			dAtA[i] = 0x12
		case *PublicKey_Ethsecp256K1:
			i -= len(x.Ethsecp256K1)
			copy(dAtA[i:], x.Ethsecp256K1)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Ethsecp256K1)))
			i--
			dAtA[i] = 0x1a
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Ethsecp256K1", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				v := make([]byte, postIndex-iNdEx)
				copy(v, dAtA[iNdEx:postIndex])
				x.Sum = &PublicKey_Ethsecp256K1{v}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
func (x *PublicKey) GetEthsecp256K1() []byte {
	if x, ok := x.GetSum().(*PublicKey_Ethsecp256K1); ok {
...
type PublicKey_Ethsecp256K1 struct {
	Ethsecp256K1 []byte `protobuf:"bytes,3,opt,name=ethsecp256k1,proto3,oneof"`
}
...
var file_tendermint_crypto_keys_proto_rawDesc = []byte{
	...
	0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7e, 0x0a, 0x09, 0x50, 0x75, 0x62, 0x6c, 0x69,
	...
	0x12, 0x24, 0x0a, 0x0c, 0x65, 0x74, 0x68, 0x73, 0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x0c, 0x65, 0x74, 0x68, 0x73, 0x65, 0x63,
	0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x3a, 0x08, 0xe8, 0xa0, 0x1f, 0x01, 0xe8, 0xa1, 0x1f, 0x01,
	0x42, 0x05, 0x0a, 0x03, 0x73, 0x75, 0x6d, 0x42, 0xab, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e,
	0x74, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x6f, 0x42, 0x09, 0x4b, 0x65, 0x79, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x22,
